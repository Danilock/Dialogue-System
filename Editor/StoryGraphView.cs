...
namespace DialogueSystem
{
    public class StoryGraphView : GraphView
    {
        ...
        public DialogueNode CreateNode(string nodeName, Vector2 position)
        {
            ...
            characterField.objectType = typeof(DialogueCharacter);
            characterField.RegisterValueChangedCallback(evt =>
            {
                tempDialogueNode.DialogueCharacter = (DialogueCharacter) evt.newValue;
            });
            tempDialogueNode.inputContainer.Add(characterField);

            var audioField = new ObjectField("AudioClip");
            audioField.objectType = typeof(AudioClip);
            audioField.RegisterValueChangedCallback(evt =>
            {
                tempDialogueNode.AudioClip = (AudioClip) evt.newValue;
            });
            tempDialogueNode.inputContainer.Add(audioField);
        ...
        public DialogueNode CreateNode(string nodeName, DialogueCharacter character, AudioClip audioClip, Vector2 position)
        {
            var tempDialogueNode = new DialogueNode()
            {
                title = nodeName,
